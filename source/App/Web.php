...
class Web extends Controller
{
    ...
    {
        $categoryUri = filter_var($data['category'], FILTER_UNSAFE_RAW);
    ...
    {
        if (!empty($data['s'])) {
            $search = filter_var($data['s'], FILTER_UNSAFE_RAW);
        ...
        $search = filter_var($data['terms'], FILTER_UNSAFE_RAW);
    ...
    public function forget(?array $data): void
    {
        if (!empty($data['csrf'])) {
            ...
            if (empty($data['email'])) {
                $json['message'] = $this->message->error("Informe seu e-mail para continuar")->render();
                echo json_encode($json);
                return;
            }
    ...
    public function register(?array $data): void
    {
        if (!empty($data['csrf'])) {
            ...
            if (in_array("", $data)) {
                $json['message'] = $this->message->info("Informe seus dados para criar a conta")->render();
                echo json_encode($json);
                return;
            }
